...
class PatientService {
  ...
  Future<Map<String, dynamic>> getMyRealtimeBookings({
    ...
    try {
      ...
      final response = await _apiClient.get('/realtime/my-bookings', queryParameters: queryParams);
  ...
  Future<Map<String, dynamic>> getRealtimeBookingDetails(String bookingId) async {
    try {
      final response = await _apiClient.get('/realtime/$bookingId');
  ...
  Future<void> cancelRealtimeBooking(String bookingId, {required String reason}) async {
    try {
      final response = await _apiClient.post('/realtime/$bookingId/cancel', data: {
        'reason': reason,
      });
  ...
  Future<Map<String, dynamic>> getRealtimeBookingDashboard() async {
    try {
      final response = await _apiClient.get('/realtime/patient/dashboard');
